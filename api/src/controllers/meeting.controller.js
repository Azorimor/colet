...
exports.create = async (req, res) => {
  ...
  meeting.save()
    ...
    .catch((error) => {
      res.json({success: false, error: serializeError(error), message: 'Could not create meeting.'});
    });
};
...
exports.getById = async (req, res) => {
  MeetingModel.findById(req.params.id)
    ...
    .catch((error) => {
      ...
      res.json({success: false, error: serializeError(error), message: 'Could not recieve meeting.'});
    })
};
...
exports.update = async (req, res) => {
  ...
  .catch((error) => {
    ...
    res.json({success: false, error: serializeError(error), message: 'Could not update meeting.'});
  });
};
...
exports.delete = async (req, res) => {
  ...
  .catch((error) => {
    res.status(404);
    res.send({success: false, error: serializeError(error), message: 'Could not delete the meeting.'});
  });
};